...
func (p *Page) MustSetWindow(left, top, width, height int) *Page {
	p.e(p.SetWindow(&proto.BrowserBounds{
		Left:        jsonvalue.Int(left),
		Top:         jsonvalue.Int(top),
		Width:       jsonvalue.Int(width),
		Height:      jsonvalue.Int(height),
...
func (p *Page) MustExpose(name string, fn func(jsonvalue.Value) (interface{}, error)) (stop func()) {
...
func (p *Page) MustEval(js string, params ...interface{}) jsonvalue.Value {
...
func (p *Page) MustObjectToJSON(obj *proto.RuntimeRemoteObject) jsonvalue.Value {
...
func (p *Page) MustObjectsToJSON(list []*proto.RuntimeRemoteObject) jsonvalue.Value {
	arr := []interface{}{}
...
func (el *Element) MustProperty(name string) jsonvalue.Value {
...
func (el *Element) MustEval(js string, params ...interface{}) jsonvalue.Value {
