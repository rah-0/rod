...
func (p *Page) MustSetExtraHeaders(dict ...string) (cleanup func()) {
	restore, err := p.SetExtraHeaders(dict)
	p.e(err)
	return func() { p.e(restore()) }
}
...
func (p *Page) MustEval(js string, params ...any) jsonvalue.Value {
...
func (el *Element) MustEval(js string, params ...any) jsonvalue.Value {
