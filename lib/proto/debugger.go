...
// DebuggerGetWasmBytecode This command is deprecated. Use getScriptSource instead.
//
// Deprecated: This protocol API is deprecated.
...
// DebuggerPauseOnAsyncCall (experimental) ...
//
// Deprecated: This protocol API is deprecated.
...
type DebuggerPaused struct {
	...
	// AsyncCallStackTraceID (experimental) (optional) Never present, will be removed.
	//
	// Deprecated: This protocol API is deprecated.
