...
// EmulationSetNavigatorOverrides (experimental) Overrides value returned by the javascript navigator object.
//
// Deprecated: This protocol API is deprecated.
...
// EmulationSetVisibleSize (experimental) Resizes the frame/viewport of the page. Note that this does not affect the frame's container
