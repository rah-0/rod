...
type NetworkHeaders map[string]jsonvalue.Value
...
type NetworkResponse struct {
	...
	// HeadersText (optional) HTTP response headers text. This has been replaced by the headers in Network.responseReceivedExtraInfo.
	//
	// Deprecated: This protocol API is deprecated.
	...
	// RequestHeadersText (optional) HTTP request headers text. This has been replaced by the headers in Network.requestWillBeSentExtraInfo.
	//
	// Deprecated: This protocol API is deprecated.
...
type NetworkReportingAPIReport struct {
	...
	// Body ...
	Body map[string]jsonvalue.Value `json:"body"`
...
// NetworkCanClearBrowserCache Tells whether clearing browser cache is supported.
//
// Deprecated: This protocol API is deprecated.
...
// NetworkCanClearBrowserCacheResult ...
//
// Deprecated: This protocol API is deprecated.
...
// NetworkCanClearBrowserCookies Tells whether clearing browser cookies is supported.
//
// Deprecated: This protocol API is deprecated.
...
// NetworkCanClearBrowserCookiesResult ...
//
// Deprecated: This protocol API is deprecated.
...
// NetworkCanEmulateNetworkConditions Tells whether emulation of network conditions is supported.
//
// Deprecated: This protocol API is deprecated.
...
// NetworkCanEmulateNetworkConditionsResult ...
//
// Deprecated: This protocol API is deprecated.
...
// NetworkContinueInterceptedRequest (experimental) Response to Network.requestIntercepted which either modifies the request to continue with any
...
// NetworkEmulateNetworkConditions Activates emulation of network conditions. This command is deprecated in favor of the emulateNetworkConditionsByRule
...
type NetworkEmulateNetworkConditionsByRule struct {
	// Offline (optional) True to emulate internet disconnection. Deprecated, use the offline property in matchedNetworkConditions
...
type NetworkSetBlockedURLs struct {
	...
	// Urls (optional) URL patterns to block. Wildcards ('*') are allowed.
	//
	// Deprecated: This protocol API is deprecated.
...
// NetworkSetRequestInterception (experimental) Sets the requests to intercept that match the provided patterns and optionally resource types.
...
// NetworkRequestIntercepted (experimental) Details of an intercepted HTTP request, which must be either allowed, blocked, modified or
// mocked.
