...
type TargetTargetInfo struct {
	...
	// type "tab".
	EmbedderData map[string]jsonvalue.Value `json:"embedderData,omitempty"`
}
...
// TargetSendMessageToTarget Sends protocol message over session with given id.
