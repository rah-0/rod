...
type OverlayGridHighlightConfig struct {
	...
	// CellBorderColor (optional) The cell border color (default: transparent). Deprecated, please use rowLineColor and columnLineColor instead.
	//
	...
	// CellBorderDash (optional) Whether the cell border is dashed (default: false). Deprecated, please us rowLineDash and columnLineDash instead.
	//
	// Deprecated: This protocol API is deprecated.
...
// OverlaySetShowHitTestBorders Deprecated, no longer has any effect.
//
// Deprecated: This protocol API is deprecated.
...
// OverlaySetShowWebVitals Deprecated, no longer has any effect.
//
// Deprecated: This protocol API is deprecated.
