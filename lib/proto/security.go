...
// SecurityHandleCertificateError Handles a certificate error that fired a certificateError event.
//
// Deprecated: This protocol API is deprecated.
...
// SecuritySetOverrideCertificateErrors Enable/disable overriding certificate errors. If enabled, all certificate error events need to
...
// SecurityCertificateError There is a certificate error. If overriding certificate errors is enabled, then it should be
...
// SecuritySecurityStateChanged The security state of the page changed. No longer being sent.
//
// Deprecated: This protocol API is deprecated.
type SecuritySecurityStateChanged struct {
	...
	// Summary (optional) Overrides user-visible description of the state. Always omitted.
	//
	// Deprecated: This protocol API is deprecated.
