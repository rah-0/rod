...
var (
	...
	Numpad7        = AddKey("7", "", "Numpad7", 103, 3)
	Numpad8        = AddKey("8", "", "Numpad8", 104, 3)
	Numpad9        = AddKey("9", "", "Numpad9", 105, 3)
	Numpad4        = AddKey("4", "", "Numpad4", 100, 3)
	Numpad5        = AddKey("5", "", "Numpad5", 101, 3)
	Numpad6        = AddKey("6", "", "Numpad6", 102, 3)
	NumpadAdd      = AddKey("+", "", "NumpadAdd", 107, 3)
	Numpad1        = AddKey("1", "", "Numpad1", 97, 3)
	Numpad2        = AddKey("2", "", "Numpad2", 98, 3)
	Numpad3        = AddKey("3", "", "Numpad3", 99, 3)
	Numpad0        = AddKey("0", "", "Numpad0", 96, 3)
	NumpadDecimal  = AddKey(".", "", "NumpadDecimal", 110, 3)
