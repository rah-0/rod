...
| FreeBSD | `amd64` | Limited | Chromium packages are published for [FreeBSD 14](https://pkg.freebsd.org/FreeBSD:14:amd64/quarterly/packagesite.pkg) and [15](https://pkg.freebsd.org/FreeBSD:15:amd64/latest/packagesite.pkg). Launcher compilation passed. Provide `Launcher.Bin`; native automation and cleanup are untested, with weaker process-group cleanup than Linux. |
